...
/////////////////////////////
 ...
 $qr="select * from   user_register where uname='$user'";
$res = $conn->query($qr);
$r = $res->fetch_assoc();
  $dd=$r['accno'];
	...
	<div class="w3ls-section gallery">
		<div class="container">   
			<div class="w3ls-title">
				<h2 class="h3-w3l">Mini Statement  </h2>
				<form name="form1" method="post" action="">
				  <table width="481" height="134" border="1" align="center">
                    <tr>
				 ...
				 $qry2="select * from mini where accno='$dd'";
...
?>
                    ...
                    <tr>
                      <td><?php echo $row2['accno'];?></td>
                      <td><?php echo $row2['amount'];?></td>
                      <td><?php echo $row2['date'];?></td>
                      <td><?php echo $row2['process'];?></td>
                      <td><?php echo $row2['taccno'];?></td>
                    </tr>
					 <?php
	  }
	  ?>
