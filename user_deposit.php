...
$id=$sid+1; 
 ...
 $qrd="insert into mini(id,accno,amount,date,process,taccno)values('$id','$accno','$amt','$date','Deposit','$accno')";
...
$r=md5($wrt);
$myfile = fopen("encrypt/deposit".$nm.".txt", "w") or die("Unable to open file!");
...
$objEmail->message("http://localhost/Secure_banking_transaction_system/user_verification.php?email=".$email."&process=Deposit&a=".$amt."&accno=".$accno);
if ($objEmail->send())
{
			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						...
						<li><a href="user_deposit.php" class="active">Deposit</a></li>    
	...
	<div class="w3ls-section gallery">
		<div class="container">   
			<div class="w3ls-title">
				<h2 class="h3-w3l">Deposit Amount  </h2>
